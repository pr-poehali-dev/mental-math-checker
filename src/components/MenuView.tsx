...
import { DifficultyLevel, TaskType, Stats, TrainingHistory } from '@/hooks/useTraining';
...
const MenuView = ({ stats, history, onStartTraining, onClearHistory }: MenuViewProps) => {
  return (
